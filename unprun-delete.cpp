...
void eraseEdge(vector<vector<int>> &hyperEdge, unordered_map<int, vector<int>> &hyperNode, unordered_map<int, int> &core, unordered_map<int, unordered_set<int>> &nodeinfo, vector<PII> &edgeinfo, const vector<int> &ee, int &vertex_num)
{
...
int main()
{
    ...
    while (ss >> str)
    {
        ...
        while (true)
        {
            ...
            {
                eraseEdge(hyperEdge, hyperNode, core, nodeinfo, edgeinfo, it.second, vertex_num);
            }
        }
